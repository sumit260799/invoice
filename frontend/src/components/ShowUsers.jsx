            ...
            {['Employee ID', 'Name', 'Email', 'Phone', 'Role', 'Action'].map(
              (header, index) => (
                <th
                  ...
                  className="py-1 text-sm px-4 bg-brandYellow text-left font-medium text-gray-800 dark:text- hover:border-l-2 hover:border-r-2 dark:hover:bg-gray-600 cursor-pointer"
                >
                  {header}{' '}
